...
export const DuckTruck = forwardRef((props, ref) => {
  const localGroup = useRef();
  const groupRef = ref || localGroup; 
    ...
    <group ref={groupRef} {...props} dispose={null}>
      <group name="Scene">
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="Fire_Truck_1fbx" rotation={[Math.PI / 2, 0, 0]} scale={0.01}>
            <group name="RootNode">
              <group name="Fire_Truck_1">
                <group name="Fire_Truck_01_Body">
                  <mesh
                    ...
                    castShadow
                    receiveShadow
                    geometry={nodes.Fire_Truck_01_Body_Fire_Truck_Mat_0.geometry}
                    ...
                    <group name="Fire_Truck_01_Cabin">
                      <mesh
                        ...
                        castShadow
                        receiveShadow
                        geometry={nodes.Fire_Truck_01_Cabin_Fire_Truck_Mat_0.geometry}
                        material={materials.Fire_Truck_Mat}
                      />
                    </group>
                    <group name="Fire_Truck_01_Glass">
                      <mesh
                        ...
                        castShadow
                        receiveShadow
                        geometry={nodes.Fire_Truck_01_Glass_Fire_Truck_Glass_Mat_0.geometry}
                    ...
                    <group name="Fire_Truck_01_Lights">
                      <mesh
                        ...
                        castShadow
                        receiveShadow
                        geometry={nodes.Fire_Truck_01_Lights_Fire_Truck_Lights__Mat_0.geometry}
                    ...
                    <group name="Fire_Truck_01_Props">
                      <mesh
                        ...
                        castShadow
                        receiveShadow
                        geometry={nodes.Fire_Truck_01_Props_Fire_Truck_Mat_0.geometry}
                        material={materials.Fire_Truck_Mat}
                      />
                    </group>
                    <group
                      ...
                      <mesh
                        ...
                        castShadow
                        receiveShadow
                        geometry={nodes.Fire_Truck_01_Steering_Fire_Truck_Mat_0.geometry}
                        material={materials.Fire_Truck_Mat}
                      />
                    </group>
                  </mesh>
        ...
        <group name="Empty" position={[0, 3.652, 0]} scale={1.976}>
          ...
          <group name="Fire_Truck_01_Wheel_FL" position={[0.531, -1.575, 1.063]} scale={0.005}>
            <mesh
          ...
          <group name="Fire_Truck_01_Wheel_FR" position={[-0.531, -1.575, 1.063]} scale={0.005}>
            <mesh
          ...
          <group name="Fire_Truck_01_Wheel_RL" position={[0.455, -1.575, -1.164]} scale={0.005}>
            <mesh
          ...
          <group name="Fire_Truck_01_Wheel_RR" position={[-0.455, -1.575, -1.164]} scale={0.005}>
            <mesh
